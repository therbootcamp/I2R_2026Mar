...
R is eine **open-source Programmiersprache** für **statistische Berechnungen und Graphiken** die von der **R Foundation for Statistical Computing** supported wird. R wird viel von **Statistkern und Datenanalysten** für die Entwicklung von statistischer Software und Datenanalyse verwendet. 
...
<font style="font-size:12px">Adaptiert von <a href="https://de.wikipedia.org/wiki/R_(Programmiersprache)">Wikipedia</a> </font>
